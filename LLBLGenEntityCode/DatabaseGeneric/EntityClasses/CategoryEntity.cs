...
namespace HomeRecipesCode.EntityClasses
{
	...
	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CategoryEntity", InheritanceHierarchyType.None, false, (int)HomeRecipesCode.EntityType.CategoryEntity, typeof(CategoryEntity), typeof(CategoryEntityFactory), false);
				AddNavigatorMetaData<CategoryEntity, EntityCollection<RecipeCategoryEntity>>("RecipeCategories", a => a._recipeCategories, (a, b) => a._recipeCategories = b, a => a.RecipeCategories, () => new CategoryRelations().RecipeCategoryEntityUsingCategoryId, typeof(RecipeCategoryEntity), (int)HomeRecipesCode.EntityType.RecipeCategoryEntity);
			}
		}
